...
import os,mimetypes
# import whitenoise.storage as wn_storage
...
# SECRET_KEY = os.environ.get('TASKMATE_SECRET_KEY')
SECRET_KEY = "django-insecure-m2xlz#m2xlz#9!=nyo(zce(4l6*-d4htq)k+y#k^b00y!pa3$_1q@(#="
